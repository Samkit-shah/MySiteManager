                ...
                <div class="card-body">
                    ...
                    <div class="row" style="padding: 5px">
                        ...
                        <div class="col-md-4" style="padding: 5px">
                            <form action="{{ route('sharenotesmail', [$user]) }}"
                                method="get">
                                <button type="submit" class="btn btn-success">
                        ...
                        <div class="col-md-2" style="padding: 5px">
                            <form action="{{ route('downloadpdfofnotes', [$user->id]) }}"
                                method="get">
                                <button type="submit" class="btn btn-success">
                                    {{ __('Download As Pdf') }}
                                </button>
                                ...
                                <div class="col-sm-4" style="padding: 5px">
                                    ...
                                    <div class="card" id="linkdetails">
                                        <div class="card-body" style="padding: 8px">
                                            ...
                                            @if($notes->typeofnote == 'list')

                                                @foreach(unserialize($notes->note_data) as $mynote)
                                                    <li>{{ $mynote }}</li>
                                                @endforeach
                                                {{-- <li>{{ unserialize($notes->note_data) }}</li> --}}
                                                <a style="font-size: 13px">Posted
                                                    On
                                                </a>{{ $notes->created_at->format('d/m/Y') }}

                                            @else

                                                <p style="text-align: justify;padding:5px">{{ $notes->note_data }}</p>
